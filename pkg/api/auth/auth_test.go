...
func TestAuthenticate(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByUsernameFn: func(db orm.DB, user string) (authapi.User, error) {
		...
		},
		{
			...
			udb: &mockdb.User{
				FindByUsernameFn: func(db orm.DB, user string) (authapi.User, error) {
					return authapi.User{Username: user}, nil
				},
			},
			sec: &mock.Secure{
		...
		},
		{
			...
			jwt: &mock.JWT{
				GenerateTokenFn: func(u authapi.User) (string, error) {
...
func TestRefresh(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByTokenFn: func(db orm.DB, token string) (authapi.User, error) {
					return authapi.User{}, authapi.ErrGeneric
				},
			},
		},
