...
func (ls *LogService) Create(c echo.Context, myProj model.Project) (p model.Project, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
func (ls *LogService) List(c echo.Context, oID string) (pt []model.Project, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
func (ls *LogService) View(c echo.Context, pID string) (pt model.Project, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
