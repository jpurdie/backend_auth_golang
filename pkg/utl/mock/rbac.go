...
type RBAC struct {
	...
	EnforceRoleFn     func(echo.Context, authapi.AccessRole) error
...
// User mock
func (a RBAC) User(c echo.Context) authapi.AuthUser {
	return a.UserFn(c)
}

// EnforceRole mock
func (a RBAC) EnforceRole(c echo.Context, role authapi.AccessRole) error {
...
// AccountCreate mock
func (a RBAC) AccountCreate(c echo.Context, roleID authapi.AccessRole, companyID, locationID int) error {
	return a.AccountCreateFn(c, roleID, companyID, locationID)
}

// IsLowerRole mock
func (a RBAC) IsLowerRole(c echo.Context, role authapi.AccessRole) error {
